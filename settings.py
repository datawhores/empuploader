...
chrome_Linux=os.path.join(workingdir,"bin/chrome_Linux/chrome")
chrome_Windows=os.path.join(os.environ.get("ProgramFiles",""),"Google\Chrome\Application\chrome.exe")
